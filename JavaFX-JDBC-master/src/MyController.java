...
*/
    ...
    public void handleButtonAction(ActionEvent event) {
        ...
        String query = "Insert into COURSN(NAME,COURSE) VALUES('" + data1 + "','" + data2 + "')";
        try {
    ...
    public  void toPdf(ActionEvent event){
        try {
            ...
            PdfWriter.getInstance(document, new FileOutputStream("C:/Hayat.pdf"));
            document.open();
